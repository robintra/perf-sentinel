...
| `listen_port_http`     | entier   | `4318`                      | Port pour le récepteur OTLP HTTP et l'endpoint Prometheus `/metrics`                                                                                                                                                                                                      |
| `listen_port_grpc`     | entier   | `4317`                      | Port pour le récepteur OTLP gRPC                                                                                                                                                                                                                                          |
