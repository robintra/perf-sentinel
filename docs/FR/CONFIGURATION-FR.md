...
| `lag_threshold_ms`   | entier   | `5000`  | Décalage temporel maximum en millisecondes entre deux findings pour les considérer co-occurrents                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `min_co_occurrences` | entier   | `5`     | Nombre minimum de co-occurrences avant de remonter une corrélation                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `min_confidence`     | flottant | `0.7`   | Score de confiance minimum (0.0 à 1.0) pour remonter une corrélation. Calculé comme `co_occurrence_count / total_occurrences_of_A`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
