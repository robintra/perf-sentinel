...
| `embodied_carbon_per_request_gco2` | flottant | `0.001`   | Terme `M` SCI v1.0 : émissions de fabrication matérielle amorties par requête (par trace), en gCO₂eq. Indépendant de la région. Doit être > 0 depuis la 0.9.25 : aucun matériel n'a un carbone incorporé nul, et un coefficient à zéro effacerait le terme M de la divulgation. La valeur appliquée est publiée dans `calibration_inputs`                                                                                                                                                                                                                                                                                                                                                    |
