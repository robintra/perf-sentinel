...
| `perf_sentinel_hub_export_dropped_total`       | counter   | (aucun)            | Entrées Hub invalides, évincées à `hub_export.max_pending`, ou finding trop grand pour le payload borné. Alertez sur `rate(...) > 0`.                                                                                                                                                |
