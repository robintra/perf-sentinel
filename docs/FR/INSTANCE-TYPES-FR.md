# Types d'instance avec un profil de puissance embarqué
...
| `MEMORY3-X16C-128G` | 7.7 | 37 |
| `MEMORY3-X24C-192G` | 11.5 | 55.4 |
| `MEMORY3-X2C-16G` | 1 | 4.6 |
| `MEMORY3-X32C-256G` | 15.4 | 73.9 |
| `MEMORY3-X48C-384G` | 23 | 110.9 |
| `MEMORY3-X4C-32G` | 1.9 | 9.2 |
| `MEMORY3-X6C-48G` | 2.9 | 13.9 |
| `MEMORY3-X8C-64G` | 3.8 | 18.5 |
| `POP2-12C-48G` | 5.5 | 23.5 |
| `POP2-16C-64G` | 7.3 | 31.3 |
| `POP2-16C-64G-WIN` | 7.3 | 31.3 |
| `POP2-24C-96G` | 10.9 | 47 |
| `POP2-2C-8G` | 0.9 | 3.9 |
| `POP2-2C-8G-WIN` | 0.9 | 3.9 |
| `POP2-32C-128G` | 14.6 | 62.6 |
| `POP2-32C-128G-WIN` | 14.6 | 62.6 |
| `POP2-48C-192G` | 21.9 | 94 |
| `POP2-4C-16G` | 1.8 | 7.8 |
| `POP2-4C-16G-WIN` | 1.8 | 7.8 |
| `POP2-64C-256G` | 29.2 | 125.3 |
| `POP2-6C-24G` | 2.7 | 11.7 |
| `POP2-8C-32G` | 3.6 | 15.7 |
| `POP2-8C-32G-WIN` | 3.6 | 15.7 |
| `POP2-HC-12C-24G` | 5.5 | 23.5 |
| `POP2-HC-16C-32G` | 7.3 | 31.3 |
| `POP2-HC-24C-48G` | 10.9 | 47 |
| `POP2-HC-2C-4G` | 0.9 | 3.9 |
| `POP2-HC-32C-64G` | 14.6 | 62.6 |
| `POP2-HC-48C-96G` | 21.9 | 94 |
| `POP2-HC-4C-8G` | 1.8 | 7.8 |
| `POP2-HC-64C-128G` | 29.2 | 125.3 |
| `POP2-HC-6C-12G` | 2.7 | 11.7 |
| `POP2-HC-8C-16G` | 3.6 | 15.7 |
| `POP2-HM-12C-96G` | 7.4 | 28.3 |
| `POP2-HM-16C-128G` | 9.8 | 37.7 |
| `POP2-HM-24C-192G` | 14.8 | 56.6 |
| `POP2-HM-2C-16G` | 1.2 | 4.7 |
| `POP2-HM-32C-256G` | 19.7 | 75.4 |
| `POP2-HM-48C-384G` | 29.5 | 113.2 |
| `POP2-HM-4C-32G` | 2.5 | 9.4 |
| `POP2-HM-64C-512G` | 39.4 | 150.9 |
| `POP2-HM-6C-48G` | 3.7 | 14.1 |
| `POP2-HM-8C-64G` | 4.9 | 18.9 |
