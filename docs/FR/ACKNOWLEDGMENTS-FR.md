...
[[acknowledged]]
signature = "slow_sql:report-service:GET__api_reports:7e9d4f0a"
...
- `sha256-prefix-of-template` correspond aux 8 premiers chars hex (4 octets) de `sha256(pattern.template)`. ~32 bits de résistance aux collisions, confortablement sous le seuil d'anniversaire pour le nombre réaliste de templates par service.
