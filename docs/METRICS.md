...
| `perf_sentinel_analysis_service_overflow_total`      | counter   | (none)                        | Analysis-side series attributions (findings, avoidable and analysed I/O ops) folded into `service="_other"` because the 128-service cap was reached (since 0.18.0). An ongoing increase means per-service attribution is coarsening for newly seen services, the totals stay exact.                                                                                                                                                                                                                         |
