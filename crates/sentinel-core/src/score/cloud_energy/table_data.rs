...
pub(super) static GENERATED_INSTANCE_ROWS: &[(&str, f64, f64)] = &[
    ...
    // CCF aws Cascade Lake: 0.690 idle / 4.063 max W/vCPU.
    ...
    // CCF aws EPYC 1st Gen: 0.847 idle / 2.604 max W/vCPU.
    ("t3a.nano", 1.7, 5.2),
    ("t3a.micro", 1.7, 5.2),
    ("t3a.small", 1.7, 5.2),
    ("t3a.medium", 1.7, 5.2),
    ...
    // CCF aws EPYC 2nd Gen: 0.474 idle / 1.693 max W/vCPU.
    ("c5a.large", 0.9, 3.4),
    ("c5a.xlarge", 1.9, 6.8),
    ...
    // CCF aws Cascade Lake: 0.690 idle / 4.063 max W/vCPU + DRAM premium (+0.16/+0.40).
    ("r5.large", 1.7, 8.9),
    ("r5.xlarge", 3.4, 17.9),
    ("r5.2xlarge", 6.8, 35.7),
    ...
    // CCF aws EPYC 1st Gen: 0.847 idle / 2.604 max W/vCPU + DRAM premium (+0.16/+0.40).
    ("r5a.large", 2.0, 6.0),
    ("r5a.xlarge", 4.0, 12.0),
    ...
    // CCF aws Ice Lake: 0.767 idle / 3.758 max W/vCPU.
    ("m6i.large", 1.5, 7.5),
    ("m6i.xlarge", 3.1, 15.0),
    ...
    // CCF aws Ice Lake: 0.767 idle / 3.758 max W/vCPU + DRAM premium (+0.16/+0.40).
    ("r6i.large", 1.9, 8.3),
    ("r6i.xlarge", 3.7, 16.6),
    ...
    // CCF aws Sapphire Rapids: 1.036 idle / 4.160 max W/vCPU.
    ("m7i.large", 2.1, 8.3),
    ("m7i.xlarge", 4.1, 16.6),
    ...
    // CCF aws Sapphire Rapids: 1.036 idle / 4.160 max W/vCPU + DRAM premium (+0.16/+0.40).
    ("r7i.large", 2.4, 9.1),
    ("r7i.xlarge", 4.8, 18.2),
    ...
    // CCF aws EPYC 4th Gen: 0.739 idle / 2.282 max W/vCPU.
    ("m7a.large", 1.5, 4.6),
    ("m7a.xlarge", 3.0, 9.1),
    ...
    // CCF aws EPYC 4th Gen: 0.739 idle / 2.282 max W/vCPU + DRAM premium (+0.16/+0.40).
    ("r7a.large", 1.8, 5.4),
    ("r7a.xlarge", 3.6, 10.7),
    ...
    // CCF aws EPYC 3rd Gen: 0.456 idle / 1.957 max W/vCPU.
    ("m6a.large", 0.9, 3.9),
    ("m6a.xlarge", 1.8, 7.8),
    ...
    // CCF aws Graviton3: 0.474 idle / 1.693 max W/vCPU.
    ...
    // CCF aws Graviton4: 0.474 idle / 1.693 max W/vCPU.
    ("m8g.large", 0.9, 3.4),
    ("m8g.xlarge", 1.9, 6.8),
    ...
    // --- m8a (AMD Turin, EPYC 5th Gen, Genoa proxy) ---
    // CCF aws EPYC 4th Gen: 0.739 idle / 2.282 max W/vCPU.
    ...
    // CCF aws Emerald Rapids: 0.814 idle / 4.482 max W/vCPU.
    ("m8i.large", 1.6, 9.0),
    ("m8i.xlarge", 3.3, 17.9),
    ...
    // CCF gcp Cascade Lake: 0.690 idle / 3.755 max W/vCPU + DRAM premium (+0.16/+0.40).
